...
To go with the [identity I designed]({% post_url 2016-03-10-rock-paper-scissors-identity %}) for Rock Paper Scissors in the winter, I wanted to create a beautifully elegant site that put the products they sell at the center of attention. I wanted to show both isolated products for sale as well as products outside of the retail context. I decided that the best way to show products in use would be through a featured product slider at the top of the home page.
